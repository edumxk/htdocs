<?php
	...
	$rat = ListaRatControl::getListaRatCTD();
		...
		<div class="row">
			...
			<div class="col-md-8"><!-- ss-->
				<h1 style="padding-bottom: 20px; padding-top: 20px">Gerência de Chamados
					<small> - Lista de CTD's Pendentes</small>
				</h1>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-12" style="padding-top: 20px">
				<div class="nav-chamado">
					<a class="btn btn-danger" href="listaClienteCtd.php" role="button">Nova CTD</a>
					<div>
					...
					<table id="table_id" class="display compact" style="width:100%">
						<thead>
							<tr>
								...
								<th style="text-align: center; width: 20px">CTD</th>
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align: center">
									<?php $d = explode('/', $r->dtEncerramento); echo ($d[2].'-'.$d[1].'-'.$d[0])?>
								</td>
								<td style="text-align: center">
									...
									<div class="">
										...
										<button type="submit" class="btn btn-sm btn-warning" onclick="novaCtd(<?php echo $r->numRat?>)">
...
<script>
	...
	function novaCtd(elm){
		window.open("ctdProd.php?numrat="+elm);
	}
</script> 
