								...
								<table style="margin: 0 auto;">
									...
									<tbody>
										<tr>
											...
											<td style="width: 100px"><input type="date" name="ate" value="<?php echo $_POST['ate']?>"></td>

											<td style="padding-left:10px"><input type="checkbox" id="pend" name="pend" value="S">Pendente</td>
