            ...
            ?>
                <div class="mapa_linha_card">
                    <div class="form-group formulario">
                        ...
                        <label class="form-control" for="setor">Linha de Produção</label>
                        <select class="form-control" name="setor" id="setor">
                            <option value="0">Tintas 5000</option>
                            <option value="1">Tintas 2000</option>
                            <option value="2">Texturas</option>
                            <option value="3">Massas</option>
                            <option value="4">Solventes</option>
                            <option value="5">Colorista</option>
                        </select>
