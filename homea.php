        ...
        <div class="row">
            ...
            <div class="col-md-3" style="padding-bottom:30px">
                <div class="card" style="width: 18rem;">
                    ...
                    <form action="modulos/abast/novoAbastecimento.php" method="GET">
            ...
            <div class="col-md-3" style="padding-bottom:30px">
                <div class="card" style="width: 18rem;">
                    ...
                    <form action="modulos/abast/lancamento.php" method="GET">
            ...
            <div class="col-md-3" style="padding-bottom:30px">
                <div class="card" style="width: 18rem;">
                    ...
                    <form action="modulos/abast/resina.php" method="GET">
