<?php 
    require_once ($_SERVER["DOCUMENT_ROOT"] . '/modulos/modCargas/Model/carga2.php');
    ...
    if(isset($_POST['action'])){
        ...
        if($_POST['action']=='editarCarga'){
            ...
            $veiculo = $_POST['query']['veiculo'];
            $data1 = $_POST['query']['data'][0];
            $data3 = $_POST['query']['data'][1];
            $data4 = $_POST['query']['data'][2];
        
            CargasControle::editarCarga($numcarga, $nome, $veiculo, $data1, $data3, $data4);
        }
        ...
        if($_POST['action']=='getFaltasCli'){
            $cod = $_POST['query'];
            CargasControle::getFaltas2($cod);
        }
        ...
        if($_POST['action']=='setSaldo'){
            $numped =   $_POST['query']['pedidos'];
 
            if(sizeof($numped)>0){
                Carga::setSaldo(($numped));
            }else
            {
                echo 'sem pedidos';
            }
    ...
    class CargasControle{
        ...
        function editarCarga($numcarga, $nome, $veiculo,  $data1, $data3, $data4 ){
            $data1 = Formatador::formatarData($data1);
            $data3 = Formatador::formatarData($data3);
            $data4 = Formatador::formatarData($data4);
            //echo $dtPrevisao;
            echo Carga::editarCarga($numcarga, $nome, $veiculo, $data1, $data3, $data4);
        }
        ...
        function getFaltas2($cod){
            //echo 'okok';
            echo json_encode(Pedido::getFaltasCliente($cod));
        }
