<?php
	...
	if(isset($_POST['busca'])){
		...
		if(isset($_POST['naoproc'])){
			$naoproc = 'S';
		}
	$rat = ListaRatControl::getListaBusca($_POST['lote'], $_POST['de'], $_POST['ate'], $pend, $proc, $naoproc);
	}else{
		$_POST['lote'] = '';
...
<body style="background-color: teal;">
	...
	<div class="header">
		<div class="row">
			...
			<div class="float-md-right">
				...
				<div class="col-sm-12" style="top: 15px; font-weight: 700; color: white">
					<a href="../../externo/logout.php">Sair</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<h1 style="padding-bottom: 20px; padding-top: 20px">Gerência de Chamados
					<small> - Lista de Todas as RAT's (Diretoria)</small>
				</h1>
			</div>
		</div>
						...
						<div class="row" style="padding-bottom:20px">
							<div class="col-md-12">
								<table style="margin: 0 auto;">
									...
									<tbody>
										<tr>
											<td style="width: 100px"><input type="text" name="lote" size="5" value="<?php echo $_POST['lote']?>"></td>
											<td style="width: 100px"><input type="date" name="de" value="<?php echo $_POST['de']?>"></td>
											<td style="width: 20px; text-align:center">a</td>
											<td style="width: 100px"><input type="date" name="ate"></td>

											<td style="padding-left:10px"><input type="checkbox" name="pend" value="S">Pendente</td>
											<td><input type="checkbox" name="naoproc" value="S">Não Procedente</td>
											<td><input type="checkbox" name="proc" value="S">Procedente</td>

											<td style="width: 100px; padding-left:20px"><input type="submit" name="busca"
													value="Buscar"></td>
										</tr>
									</tbody>
								</table>
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: center" class="row">
								<form class="col-sm-1" action="diretoriaRat.php" method="post">
									<input type="hidden" name="numrat" value="<?php echo $r->numRat?>" />
								...
								<div class="col-sm-1">
									...
									<button type="submit" class="btn btn-sm btn-success"
										onclick="openpdf(<?php echo $r->numRat?>)">
	...
	<div class="row" hidden>
		<div class="col-md-12" style="padding-bottom: 10px;">
			<!-- ss-->
			<div id="secao" class="btn btn-primary" data-toggle="collapse" href="#collapse2" role="button"
				aria-controls="collapse2" style="width:100%; padding-bottom:30px">Graficos
