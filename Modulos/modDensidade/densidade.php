...
if(isset($_GET['data1'], $_GET['data2'])){
    ...
    $laudos =  produto::dados(Model::getDados($data1, $data2));
}else
    $laudos =  produto::dados(Model::getDados($data1, $data2));
//download
...
<body>
    ...
    <div class="conteiner">
        ...
        <div class="exportar"><a href="densidade.csv"><Button class="btn btn-primary">Download Planilha</Button></a></div>
    </div>
    <div class="tabela">
        <table id="laudos" class="table table-striped table-hover">
            <thead>
                <tr>
                    <th><span class="laudo">ID Laudo</span></th>
                    <th><span class="laudo">lote</span></th>
                    <th><span class="laudo">Data</span></th>
                    <th><span class="laudo">Codprod</span></th>
                    <th><span class="laudo">Descrição</span></th>
                    <th><span class="laudo">Qt Produzida</span></th>
                    <th><span class="laudo">Peso Formula</span></th>
                    <th><span class="laudo">Litragem</span></th>
                    <th><span class="laudo">Valor Padrão</span></th>
                    <th><span class="laudo">Densidade</span></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $p->padrãoLaudo ?></td>
                    <td><?= number_format(($p->densidadeLaudo),3,',','.') ?></td>
                    <td><?= $p->codprodSa ?></td>
                    <td><?= $p->descricaoSa ?></td>
                </tr>
                <?php endforeach; ?>
