...
<head>
	...
	<link href="Recursos/img/favicon.ico" rel="shortcut icon" type="image/x-icon" />
		...
		<div class="row">
			...
			<div class="col-md-8"><!-- ss-->
				<h1 style="padding-bottom: 20px; padding-top: 20px">Gerência de Chamados
					<small> - Lista de RAT's Pendentes</small>
				</h1>
			</div>
					...
					<table id="table_id" class="display compact" style="width:100%">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align: center">
									<?php echo formatador::dataFormatUs($r->dtAbertura)?>
								</td>
								<td style="text-align: center">
									<?php echo $r->codCli?>
								</td>
								...
								<td style="text-align: center">
									<?php $dias = ListaRatControl::getDuracao($r->dtAbertura, $r->dtEncerramento);
										echo $dias;
										if($dias > 3):?>
								...
								<td style="text-align: center" class="row">
									...
									<form class="col-sm-1" action="editarRat.php" method="post">
