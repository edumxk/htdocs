<?php
include_once ($_SERVER["DOCUMENT_ROOT"] . '/model/pdf/fpdf.php');
include_once ($_SERVER["DOCUMENT_ROOT"] . '/modulos/modChamados/Model/rat.php');
//require('../../../../model/pdf/fpdf.php');
...
class PdfFinal{
    ...
    public static function salvarArquivo($numrat){
        ...
        $pdf->Image($_SERVER["DOCUMENT_ROOT"] . '/recursos/src/Logo-kokar.png',20,11,20); 
        ...
        if(sizeof($chamado->corretiva)>0){
            ...
            $pdf->Cell(115,6,utf8_decode('DESPESA'),1,0,'C',1); 
            $pdf->Cell(10,6,utf8_decode('QT'),1,0,'C',1); 
            $pdf->Cell(25,6,utf8_decode('VALOR'),1,0,'C',1); 
            ...
            foreach($chamado->corretiva as $c){
                ...
                $pdf->Cell(115,6,utf8_decode($c->despesa),1,0); 
        ...
        $filename=$_SERVER["DOCUMENT_ROOT"] . '/modulos/modChamados/Recursos/pdfGerados/rat'.$chamado->numRat.'.pdf';
